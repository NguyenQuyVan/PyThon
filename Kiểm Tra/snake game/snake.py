...
pygame.init()
#load hình ảnh
m= 20  # kích thước chiều cao % rộng
Imgbody = pygame.transform.scale(pygame.image.load('than.jpg'),(m,m))
Imghead = pygame.transform.scale(pygame.image.load('dau.jpg'),(m,m))
...
def game_over():
    ...
    gsurf = gfont.render('Anh Yêu Em Honey',True,red)
...
def show_score(choice = 1):
    ...
    ssurf = sfont.render('MY LOVE: {0} '.format(score),True,black)
...
while True:
    ...
    # xử lí di chuyển đụng 4 cạnh biên
