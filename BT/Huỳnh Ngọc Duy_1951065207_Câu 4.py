...
data={'Điện thoại':120,'Máy Tính':400,'Ipad':260,'Tivi':250,'Bếp điện':99,'Bàn ủi':124,'Tủ Lạnh':580};
plt.bar(range(len(data)),list(data.values()))
plt.xticks(range(len(data)),data.keys())
plt.title("Biểu đồ cột thống kê số lượng sản phẩm")
plt.show();
...
#Lưu bảng dữ liệu xuống 1 file tên là xyz.xlsx
import pandas as pd
...
#Cột tổng ở câu b lưu xuống file 
import openpyxl
